...
function App() {
  ...
  const welcomeText = WelcomeScreen(); // why create a variable for a React component, you can use directly in JSX by using <WelcomeScreen/>
  ...
  return (
    <ListContext.Provider value={{ list, updateShopping, deleteItem }}>
      <div className="App">
        ...
        <button onClick={() => dispatch({ type: "show" })} className="btn">
          Add Item
        </button>
